...
if (Tools::getValue('action') && Tools::getValue('id_product_comment') && Context::getContext()->cookie->id_customer) {
    ...
    } elseif (Tools::getValue('action') == 'usefulness' && Tools::getValue('value') && Tools::getValue('value')) {
...
} elseif (Tools::getValue('action') && Tools::getValue('secure_key') == $productCom->secure_key) {
