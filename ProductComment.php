...
class ProductComment extends ObjectModel
{
	...
	public static function getByProduct($id_product, $p = 1, $n = null, $id_customer = null)
	{
		...
		if (!Cache::isStored($cache_id))
		{
			...
			IF(c.id_customer, CONCAT(c.`firstname`, \' \',  LEFT(c.`lastname`, 1), \'.\'), pc.customer_name) customer_name, pc.`content`, pc.`grade`, pc.`date_add`, pc.title, pc.id_customer, pc.id_guest
