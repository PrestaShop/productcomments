...
class ProductComments extends Module
{
    ...
    public function getConfigFieldsValues()
    {
        return array(
            ...
            'PRODUCT_COMMENTS_ALLOW_ALREADY_ORDERED' => (int) Tools::getValue('PRODUCT_COMMENTS_ALLOW_ALREADY_ORDERED', Configuration::get('PRODUCT_COMMENTS_ALLOW_ALREADY_ORDERED')),
        );
    }
