      ...
      <div class="modal-body">
        ...
        <div class="row">
          <div class="col-md-12  col-sm-12 post-comment-buttons">
            <button type="button" class="btn btn-comment-inverse btn-comment-huge refuse-button" data-dismiss="modal" aria-label="{l s='No' mod='productcomments'}">
              {l s='No' mod='productcomments'}
            </button>
            <button type="button" class="btn btn-comment btn-comment-huge confirm-button" data-dismiss="modal" aria-label="{l s='Yes' mod='productcomments'}">
